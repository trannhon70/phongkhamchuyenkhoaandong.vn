...
<body>
    <?php if (isset($getPostDetail)) { ?>
        ...
        <footer class="footer__mobile">
            <img loading="lazy" width="100%" height="auto" src="<?php echo $local ?>/images/background/footer_mobile.gif"
                alt="...">
            <div class="footer__mobile_list">
                <a class="footer__mobile_list_left" target="_blank"
                ...
                <a class="footer__mobile_list_right" href="https://npa.zoosnet.net/LR/Chatpre.aspx?id=NPA46777247&lng=en"
